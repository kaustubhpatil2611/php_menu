...
<body style="background-color:#f2e6ff;" >
    ...
    <div class="container" >
        <div class="row">
            <div class="col-12" style="color: #660066;">
        ...
        <div class="row row-content align-items-center">
            <div class="col-12">
                <div class="card">
                    <h3 class="card-header text-white" style="background-color:#cc33ff;">Item Details</h3>
                    <div class="card-body" style="color: #660066;background-color:#f5ccff;">
